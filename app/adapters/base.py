...
class LLMAdapter(ABC):
    ...
    def format_image_block(self, image: dict) -> dict:
        """
        Convert a provider-agnostic image dict into a content block.
        Input: {"data": base64_str, "media_type": "image/jpeg"}
        Output: provider-specific content block for use in a multimodal message.
        Default: OpenAI-compatible format. Override for other providers.
        """
        return {
            "type": "image_url",
            "image_url": {
